...
func TestPlainPrintStart(t *testing.T) {
	t.Run("hostname target reports its resolution time", func(t *testing.T) {
		out := captureStdout(t, func() {
			NewPlainPrinter(config.PrinterConfig{}).PrintStart(plainTestStats())
		})
	...
	t.Run("IP target has no resolution time", func(t *testing.T) {
		...
		out := captureStdout(t, func() {
			NewPlainPrinter(config.PrinterConfig{}).PrintStart(s)
		})
...
func TestPlainPrintNameResolutionDuration(t *testing.T) {
	t.Run("prints on its own line", func(t *testing.T) {
		out := captureStdout(t, func() {
			NewPlainPrinter(config.PrinterConfig{}).PrintNameResolutionDuration(plainTestStats())
		})
	...
	t.Run("stays quiet when the probe line already says it", func(t *testing.T) {
		...
		out := captureStdout(t, func() {
			NewPlainPrinter(config.PrinterConfig{}).PrintNameResolutionDuration(s)
		})
...
func TestPlainPrintProbeSuccess(t *testing.T) {
	out := captureStdout(t, func() {
		NewPlainPrinter(config.PrinterConfig{}).PrintProbeSuccess(plainTestStats())
	})
...
func TestPlainPrintProbeFailure(t *testing.T) {
	out := captureStdout(t, func() {
		NewPlainPrinter(config.PrinterConfig{}).PrintProbeFailure(plainTestStats())
	})
...
func TestPlainProbeShowsIPTargetOnce(t *testing.T) {
	...
	out := captureStdout(t, func() {
		NewPlainPrinter(config.PrinterConfig{}).PrintProbeSuccess(s)
	})
...
func TestPlainProbeTimestampAndSourceAddress(t *testing.T) {
	...
	cfg := config.PrinterConfig{WithTimestamp: true, WithSourceAddress: true}
...
func TestPlainProbeShowsResolutionInline(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		t.Run(tt.name, func(t *testing.T) {
			out := captureStdout(t, func() {
				tt.print(NewPlainPrinter(config.PrinterConfig{}))
			})
...
func TestPlainProbeUDPFailureReason(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			out := captureStdout(t, func() {
				NewPlainPrinter(config.PrinterConfig{}).PrintProbeFailure(s)
			})
...
func TestPlainProbeVerboseUDPDetails(t *testing.T) {
	...
	out := captureStdout(t, func() {
		NewPlainPrinter(config.PrinterConfig{Verbose: true}).PrintProbeSuccess(s)
	})
...
func TestPlainPrintStatistics(t *testing.T) {
	...
	out := captureStdout(t, func() {
		NewPlainPrinter(config.PrinterConfig{}).PrintStatistics(s)
	})
...
func TestPlainShutdownPrintsStatistics(t *testing.T) {
	...
	out := captureStdout(t, func() {
		NewPlainPrinter(config.PrinterConfig{}).Shutdown(s)
	})
...
func TestPlainShutdownOmitsStatistics(t *testing.T) {
	...
	out := captureStdout(t, func() {
		NewPlainPrinter(config.PrinterConfig{OmitStatistics: true}).Shutdown(s)
	})
